...
func (a *App) Start(ctx context.Context) (err error) {
	...
	for _, ipt := range []*iptables.IPTables{a.nfHelper.IPTables4, a.nfHelper.IPTables6} {
		...
		ipt.RegisterChainOverlay("filter", "FORWARD")
		ipt.RegisterChainOverlay("mangle", "PREROUTING")
		ipt.RegisterChainOverlay("nat", "PREROUTING")
		ipt.RegisterChainOverlay("nat", "POSTROUTING")
	}
